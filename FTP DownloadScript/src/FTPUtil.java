...
public class FTPUtil {
    ...
    public static boolean downloadSingleFile(FTPClient ftpClient, String remoteFilePath, String savePath) throws IOException {
        ...
        System.out.println("Save Path " + downloadFile.getParent() + "  Already Exits? " + downloadFile.exists() );
        System.out.println("Save Path " + downloadFile.getPath() + "  Already Exits? " + downloadFile.exists() );
